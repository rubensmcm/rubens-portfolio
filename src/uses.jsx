...
<section className="uses-section">
  <div className="uses-header">
    <img src={`${process.env.PUBLIC_URL}/images/computer.png`} alt="Workstation" className="uses-icon" />
    <h2>Workstation</h2>
  </div>
  <ul>
...
<section className="uses-section">
  <div className="uses-header">
    <img src={`${process.env.PUBLIC_URL}/images/source-code.png`} alt="Development Tools" className="uses-icon" />
...
<section className="uses-section">
  <div className="uses-header">
    <img src={`${process.env.PUBLIC_URL}/images/edit-text.png`} alt="Design Tools" className="uses-icon" />
    <h2>Design</h2>
  </div>
  <ul>
...
<section className="uses-section">
  <div className="uses-header">
    <img src={`${process.env.PUBLIC_URL}/images/list.png`} alt="Productivity Tools" className="uses-icon" />
