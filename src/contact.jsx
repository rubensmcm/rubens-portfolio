    ...
    <>
      ...
      <main>
        <section>
          ...
          >
            <h2>CONTACT RUBENS</h2>
            <p>Rubens Marcolino</p>
            <p>Phone: +1 (385) 233-164</p>
            <p>Email: rubensmc4@gmail.com</p>

            <section className="adventures">
              <h2>I'm here to collaborate with you</h2>
          ...
          >
            <form>
              ...
              <div className="submission">
                ...
                <label htmlFor="subscribe">Subscribe me to updates</label>
              </div>
